...
image::https://github.com/riscv/riscv-plic-spec/tree/master/Images/PLIC.jpg[GitHub]
...
image::https://github.com/riscv/riscv-plic-spec/tree/master/Images/PLICArch.jpg[GitHub]
