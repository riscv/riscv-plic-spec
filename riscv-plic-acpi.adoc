...
image::Images/Figure5-24.jpg[GitHub,1000,705,link=https://github.com/riscv/riscv-plic-spec/blob/master/Images/Figure5-24.jpg]

#### Figure 5.24 PLIC-Global System Interrupts (Single Processor and Single PLIC Scenario)

image::Images/Figure5-25.jpg[GitHub,1000,705,link=https://github.com/riscv/riscv-plic-spec/blob/master/Images/Figure5-25.jpg]
